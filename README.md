...
Este projeto possui o objetivo principal **Desenvolver um sistema um E-commerce**.  
Com os objetivos gerais de realizar a vendas de **Produtos**, cadastrados de usuários e o controle do **estoque**. 
